...
import 'package:mypasarv2/views/screens/newhomestayscreen.dart';
              ...
              : Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Your current homestays/services (${homestayList.length} found)",
                        style: const TextStyle(
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${Config.SERVER}/assets/homestayimages/${homestayList[index].homestayId}a.png",
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadhomestays() {
    ...
    http
        .get(
      Uri.parse(
          "${Config.SERVER}/php/loadsellerhomestays.php?userid=${widget.user.id}"),
    )
        .then((response) {
